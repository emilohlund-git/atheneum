...
const PasswordEyeOpened = () => {
  return (
    <svg
      ...
      height="1em"
      width="1em"
      className="absolute top-1/2 right-0 -translate-y-1/2 mr-4 opacity-30 text-2xl hover:bg-dark-default rounded-full cursor-pointer hover:bg-opacity-10 p-1"
    >
      <path
        fill="currentColor"
...
export default PasswordEyeOpened;
